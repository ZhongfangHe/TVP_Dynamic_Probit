...
function [ytp1_pdf, ytp1_pdf_vec] = Pred_DProbTVP(draws, xtp1, ytp1)
% Inputs:
...
%     beta_sparse_std = beta_std;
    ...
    if ytp1 == 1
        ytp1_pdf_vec(drawi,1) = normcdf(xztp1' * beta / beta_std);
%         ytp1_pdf_vec(drawi,2) = normcdf(xztp1' * beta_sparse / beta_sparse_std);
    else
        ytp1_pdf_vec(drawi,1) = 1 - normcdf(xztp1' * beta / beta_std);
%         ytp1_pdf_vec(drawi,2) = 1 - normcdf(xztp1' * beta_sparse / beta_sparse_std);
    end
end
